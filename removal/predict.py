...
def main(args):
    ...
    img_name = args.img.split('/')[-1]
    raw_out.save(os.path.join("examples/", "ori_{}".format(img_name)))


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Specify the inputs")
    parser.add_argument('--img', type=str, default="examples/naviID_32_devID_1_pos_2_1_2.jpg")
    parser.add_argument('--mask', type=str, default="examples/2.png")
