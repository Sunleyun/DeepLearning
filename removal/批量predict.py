...
def main(args):
    ...
    out.save(os.path.join("C:/Users/ying/Desktop/wheel_navilD_ori/wheelset_highlight_result/60-69/seg_modle3/result", "out_{}".format(img_name)))
...
if __name__ == "__main__":
    for i in range(10):
        ...
        parser.add_argument('--img', type=str, default="D:/datafile/数据集/DRIVE_interest2/training/images/6" + str(j) + "_training.tif")
        parser.add_argument('--mask', type=str, default="C:/Users/ying/Desktop/wheel_navilD_ori/wheelset_highlight_result/60-69/seg_modle3/mask/6" + str(j) + "_mask.png")
